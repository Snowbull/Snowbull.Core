/**
 * Get EPF Points Request Packet for Snowbull ("Snowbull").
 *
...
namespace Snowbull.Core.Packets.Xt.Receive.Player.EPF {
    public sealed class GetEPFPoints : XtPacket, IReceivePacket {
        public GetEPFPoints(XtData xt) : base(xt) {}
    }
}