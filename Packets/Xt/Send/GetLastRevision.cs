/**
 * Get Last Revision Response Packet for Snowbull's Plugin API ("Snowbull").
 *
...
namespace Snowbull.Core.Packets.Xt.Send {
    public class GetLastRevision : XtPacket, ISendPacket {
        public GetLastRevision(int revision) : base(
            new XtData(
                From.Server,
                "glr",
                new string[] { revision.ToString() }
            )
        ) {
        }
    }
